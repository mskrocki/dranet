...
require (
	...
	sigs.k8s.io/multi-network-api v0.0.0-00010101000000-000000000000
)
...
replace sigs.k8s.io/multi-network-api => github.com/mskrocki/multi-network-api v0.0.0-20250515235916-2c481d550117
